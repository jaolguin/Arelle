...
from arelle.xlrd.biffh import *
from arelle.xlrd.formula import dump_formula, decompile_formula, rangename2d
from arelle.xlrd.formatting import nearest_colour_index, Format
from arelle.xlrd.xfcell import XFCell
...
class Sheet(BaseObject):
    ...
    def fake_XF_from_BIFF20_cell_attr(self, cell_attr):
        from arelle.xlrd.formatting import XF, XFAlignment, XFBorder, XFBackground, XFProtection
        xf = XF()
